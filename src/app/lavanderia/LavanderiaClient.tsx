  ...
  <div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center mb-16">
        <div className="flex flex-col items-center p-4">
            ...
            <h3 className="font-semibold text-gray-800 text-xl mb-2">Cuidado de Prendas</h3>
            <p className="text-gray-600">Tratamos cada prenda con el cuidado que merece, utilizando productos de alta calidad.</p>
        </div>
        <div className="flex flex-col items-center p-4">
            <FaClock className="text-blue-600 text-5xl mb-3" />
            <h3 className="font-semibold text-gray-800 text-xl mb-2">Servicio Rápido</h3>
            <p className="text-gray-600">Tu ropa limpia y lista en el menor tiempo posible, para que no tengas que esperar.</p>
        </div>
        <div className="flex flex-col items-center p-4">
            <FaHandsHelping className="text-blue-600 text-5xl mb-3" />
            <h3 className="font-semibold text-gray-800 text-xl mb-2">Comodidad</h3>
            <p className="text-gray-600">Disfruta de la comodidad de un servicio profesional sin salir de casa.</p>
        </div>
        <div className="flex flex-col items-center p-4">
            ...
            <p className="text-gray-600">Resultados impecables en cada prenda, garantizando tu satisfacción.</p>
        </div>
    </div>
    ...
    <div className="bg-blue-800 py-16 text-white text-center">
        <div className="container mx-auto px-4">
            ...
            <a href="https://wa.me/523323254619?text=Hola%2C%20me%20interesan%20sus%20servicios%20de%20lavanderia%20para%20el%20hogar." target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-green-600 transition-colors shadow-lg flex items-center justify-center max-w-xs mx-auto">
...
const CorporativoContent = () => (
  <div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center mb-16">
        <div className="flex flex-col items-center p-4">
            <FaTshirt className="text-blue-600 text-5xl mb-3" />
            <h3 className="font-semibold text-gray-800 text-xl mb-2">Uniformes Impecables</h3>
            <p className="text-gray-600">Mantenemos los uniformes de tu personal siempre limpios y presentables.</p>
        </div>
        <div className="flex flex-col items-center p-4">
            <FaClock className="text-blue-600 text-5xl mb-3" />
            <h3 className="font-semibold text-gray-800 text-xl mb-2">Puntualidad</h3>
            <p className="text-gray-600">Entregas puntuales para que tu operación nunca se detenga.</p>
        </div>
        <div className="flex flex-col items-center p-4">
            <FaHandsHelping className="text-blue-600 text-5xl mb-3" />
            <h3 className="font-semibold text-gray-800 text-xl mb-2">Servicio Personalizado</h3>
            <p className="text-gray-600">Nos adaptamos a las necesidades específicas de tu empresa.</p>
        </div>
        <div className="flex flex-col items-center p-4">
            <FaCheckCircle className="text-blue-600 text-5xl mb-3" />
            <h3 className="font-semibold text-gray-800 text-xl mb-2">Máxima Higiene</h3>
            <p className="text-gray-600">Procesos de lavado que garantizan la máxima higiene y desinfección.</p>
        </div>
    </div>
    ...
    <div className="bg-blue-800 py-16 text-white text-center">
        <div className="container mx-auto px-4">
            ...
            <a href="https://wa.me/523323254619?text=Hola%2C%20estoy%20interesado%20en%20sus%20servicios%20de%20lavanderia%20corporativa." target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-green-600 transition-colors shadow-lg flex items-center justify-center max-w-xs mx-auto">
                <FaWhatsapp className="mr-2" /> Cotiza Ahora
            </a>
        </div>
    </div>
  </div>
      ...
      <div className="container mx-auto px-4 py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-md">
                    ...
                    <h3 className="font-semibold text-gray-800 text-xl mb-2">1. Recepción</h3>
                    <p className="text-gray-600 text-sm">Trae tu ropa o solicita nuestro servicio de recolección. Clasificamos tus prendas para darles el mejor tratamiento.</p>
                </div>
                <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-md">
                    <FaHandsHelping className="text-green-500 text-5xl mb-3" />
                    <h3 className="font-semibold text-gray-800 text-xl mb-2">2. Lavado Profesional</h3>
                    <p className="text-gray-600 text-sm">Utilizamos detergentes de alta calidad y equipos modernos que cuidan tus prendas y el medio ambiente.</p>
                </div>
                <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-md">
                    <FaClock className="text-green-500 text-5xl mb-3" />
                    <h3 className="font-semibold text-gray-800 text-xl mb-2">3. Secado y Planchado</h3>
                    <p className="text-gray-600 text-sm">Secamos tus prendas a la temperatura ideal y ofrecemos un planchado experto para un acabado perfecto.</p>
                </div>
                <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-md">
                    <FaCheckCircle className="text-green-500 text-5xl mb-3" />
                    <h3 className="font-semibold text-gray-800 text-xl mb-2">4. Entrega Impecable</h3>
                    <p className="text-gray-600 text-sm">Recoge tu ropa fresca, doblada y lista para usar, o recíbela cómodamente en tu domicilio.</p>
                </div>
            </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-16">
            ...
            <div className="max-w-4xl mx-auto bg-white p-4 rounded-lg shadow-md text-center">
                <p className="text-gray-700 text-lg mb-4 flex items-center justify-center">
                    ...
                    Av. Independencia 2550, 45200 Granja Luz Aidé, Jal.
                </p>
                ...
                <a
                    href="https://maps.app.goo.gl/iUQlv2KOJdRnoRkQa"
                    target="_blank"
